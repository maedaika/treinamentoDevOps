...
/*  47:    */   {
/*  48: 43 */     JLabel lblNome = new JLabel(this.baca.getResource().getString(
/*  49: 44 */       "gui.label.nomeParametro"));
...
/*  54:    */     
/*  55: 50 */     int option = 
/*  56: 51 */       JOptionPane.showConfirmDialog(this.baca, msg, this.baca.getResource().getString(
/*  57: 52 */       "gui.title.preencheParametro"), 2);
/*  58: 53 */     if (option == 0)
/*  59:    */     {
...
/*  83:    */       {
					  //Comentado depois da decolicao do codigo
...
/* 121:103 */           body = body + OrderUtils.updateContent(parametro, 
/* 122:104 */             "valor_parametro_smp", value, this.baca.getServerConfig().getProperty("separator"));
/* 123:    */         }
/* 124:    */       }
/* 125:    */     }
 ...
 * Qualified Name:     br.com.brasiltelecom.oms.xmlapi.baca.acao.PreencheParametro
