...
/*  79: 79 */     this.valores.put("PLANO BASICO - CONDOR SUPER CENTER", "ELM_PL_BAS_POS_CONDO");
/*  80: 80 */     this.valores.put("PLANO BASICO - MAKRO", "ELM_PL_BAS_POS_MAKRO");
/*  81: 81 */     this.valores.put("PLANO BASICO - PLAZA VEACULOS", "ELM_PL_BAS_POS_PLAZA");
/*  82: 82 */     this.valores.put("PLANO BASICO - POLLOSHOP", "ELM_PL_BAS_POS_POLLO");
/*  83: 83 */     this.valores.put("PLANO BASICO - SENAI", "ELM_PL_BAS_POS_SENAI");
/*  84: 84 */     this.valores.put("PLANO BASICO - SERVOPA S/A INDÚSTRIA E COMÉRCIO   ", 
/*  85: 85 */       "ELM_PL_BAS_POS_SERVO");
/*  86: 86 */     this.valores.put("PLANO BASICO - VECODIL COM DE VEACULOS LTDA       ", 
...
/* 112:    */   {
/* 113:112 */     JLabel lblNome = new JLabel(this.baca.getResource().getString(
/* 114:113 */       "gui.label.nomeServico"));
/* 115:114 */     JLabel lblStatus = new JLabel(this.baca.getResource().getString(
/* 116:115 */       "gui.label.status"));
...
/* 120:    */     
/* 121:120 */     int option = JOptionPane.showConfirmDialog(this.baca, msg, this.baca.getResource()
/* 122:121 */       .getString("gui.title.trocaServico"), 2);
/* 123:122 */     if (option == 0)
/* 124:    */     {
/* 125:123 */       this.nomeServico = ((String)this.combo.getSelectedItem());
/* 126:124 */       this.nomeServico = 
/* 127:125 */         ((String)(this.valores.get(this.nomeServico) != null ? this.valores.get(this.nomeServico) : this.nomeServico));
/* 128:126 */       this.nomeStatus = ((String)this.cmbStatus.getSelectedItem());
/* 129:127 */       this.nomeStatus = 
/* 130:128 */         ((String)(this.status.get(this.nomeStatus) != null ? this.status.get(this.nomeStatus) : this.nomeStatus));
 ...
 * Qualified Name:     br.com.brasiltelecom.oms.xmlapi.baca.acao.TrocaStatus
