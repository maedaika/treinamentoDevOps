...
/*  28:    */   {
/*  29: 24 */     JLabel lblCodigoErro = new JLabel(this.baca.getResource().getString(
/*  30: 25 */       "gui.label.codigoErro"));
/*  31: 26 */     JLabel lblDescricaoErro = new JLabel(this.baca.getResource().getString(
/*  32: 27 */       "gui.label.descricaoErro"));
...
/*  38:    */     
/*  39: 34 */     int option = JOptionPane.showConfirmDialog(this.baca, msg, this.baca.getResource()
/*  40: 35 */       .getString("gui.title.preencheErro"), 2);
/*  41: 36 */     if (option == 0)
/*  42:    */     {
 ...
 * Qualified Name:     br.com.brasiltelecom.oms.xmlapi.baca.acao.AdicionaDescricao
