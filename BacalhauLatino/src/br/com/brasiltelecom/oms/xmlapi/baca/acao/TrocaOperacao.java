...
/*  79: 89 */     this.valores.put("PLANO BASICO - CONDOR SUPER CENTER", "ELM_PL_BAS_POS_CONDO");
/*  80: 90 */     this.valores.put("PLANO BASICO - MAKRO", "ELM_PL_BAS_POS_MAKRO");
/*  81: 91 */     this.valores.put("PLANO BASICO - PLAZA VEICULOS", "ELM_PL_BAS_POS_PLAZA");
/*  82: 92 */     this.valores.put("PLANO BASICO - POLLOSHOP", "ELM_PL_BAS_POS_POLLO");
/*  83: 93 */     this.valores.put("PLANO BASICO - SENAI", "ELM_PL_BAS_POS_SENAI");
/*  84: 94 */     this.valores.put("PLANO BASICO - SERVOPA S/A INDÚSTRIA E COMÉRCIO   ", 
/*  85: 95 */       "ELM_PL_BAS_POS_SERVO");
/*  86: 96 */     this.valores.put("PLANO BASICO - VECODIL COM DE VEICULOS LTDA       ", 
/*  87: 97 */       "ELM_PL_BAS_POS_VECOD");
/*  88: 98 */     this.valores.put("PLANO COLABORADOR", "ELM_PL_POS_COLABORAD");
/*  89: 99 */     this.valores.put("PLANO INDICADO (NAO COLABORADOR)", "ELM_PL_POS_INDICADO");
...
/* 123:    */   {
/* 124:133 */     JLabel lblNome = new JLabel(this.baca.getResource().getString(
/* 125:134 */       "gui.label.nomeServico"));
/* 126:135 */     JLabel lblOperacao = new JLabel(this.baca.getResource().getString(
/* 127:136 */       "gui.label.operacao"));
...
/* 131:    */     
/* 132:141 */     int option = JOptionPane.showConfirmDialog(this.baca, msg, this.baca.getResource()
/* 133:142 */       .getString("gui.title.trocaServico"), 2);
/* 134:143 */     if (option == 0)
/* 135:    */     {
/* 136:144 */       this.nomeServico = ((String)this.combo.getSelectedItem());
/* 137:145 */       this.nomeServico = 
/* 138:146 */         ((String)(this.valores.get(this.nomeServico) != null ? this.valores.get(this.nomeServico) : this.nomeServico));
/* 139:147 */       this.nomeOperacao = ((String)this.cmbOperacao.getSelectedItem());
/* 140:148 */       this.nomeOperacao = 
/* 141:149 */         ((String)(this.operacao.get(this.nomeOperacao) != null ? this.operacao.get(this.nomeOperacao) : this.nomeOperacao));
 ...
 * Qualified Name:     br.com.brasiltelecom.oms.xmlapi.baca.acao.TrocaOperacao
